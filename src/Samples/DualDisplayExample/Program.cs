...
var settings1 = new SpiConnectionSettings(0, 1)
{
    ClockFrequency = 24_000_000, // 尝试降低SPI时钟频率以减少闪烁
    Mode = SpiMode.Mode0,
};

var settings2 = new SpiConnectionSettings(0, 0)
{
...
// 创建显示屏对象
using var display1 = new ST7789Display(settings1, gpio, dcPin: 25, resetPin: 27, displayType: DisplayType.Display147Inch);
