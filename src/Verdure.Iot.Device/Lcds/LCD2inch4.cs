...
public class LCD2inch4 : LcdConfig
{
    ...
    public LCD2inch4(SpiDevice spi, SoftwarePwmChannel pwmBacklight, GpioController gpio, int spiFreq = 40000000, int rst = 27, int dc = 25, int bl = 18, int blFreq = 1000) : base(spi, pwmBacklight, gpio, spiFreq, rst, dc, bl, blFreq)
    {
    }
